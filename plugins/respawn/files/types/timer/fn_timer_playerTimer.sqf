/* ----------------------------------------------------------------------------
Function: respawn_fnc_timer_playerTimer
...
Returns:
	nothing
Examples:
	_unit call respawn_fnc_timer_playerTimer;
Author:
	nigel
---------------------------------------------------------------------------- */
...
waitUntil {
	...
	private _timerTime = missionNamespace getVariable ["respawn_timerTime",RESPAWN_PARAM_TIMERTIME];
