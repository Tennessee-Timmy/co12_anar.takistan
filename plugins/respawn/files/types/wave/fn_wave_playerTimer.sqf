/* ----------------------------------------------------------------------------
Function: respawn_fnc_wave_playerTimer
...
Returns:
	nothing
Examples:
	_unit call respawn_fnc_wave_playerTimer;
Author:
	nigel
---------------------------------------------------------------------------- */
...
private _availableWaves = missionNamespace getVariable [_wavesVar,RESPAWN_PARAM_WAVECOUNT];
